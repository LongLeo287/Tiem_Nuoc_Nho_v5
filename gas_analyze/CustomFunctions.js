 ...
 * @param {Array<Array<string>>} cotNgay      Cột TIMESTAMP (Cột B của ORDERS)
 * @param {Array<Array<number>>} cotTien      Cột THANH_TIEN (Cột H của ORDERS)
 * @param {Array<Array<string>>} cotTrangThai Cột TRANG_THAI (Cột I của ORDERS)
 ...
 * @param {Array<Array<string>>} cotLoai      Cột phan_loai (Cột C của SOTAY)
 * @param {Array<Array<number>>} cotSoTien    Cột so_tien (Cột E của SOTAY)
 * @param {Array<Array<string>>} cotThoiGian  Cột thoi_gian (Cột B của SOTAY)
